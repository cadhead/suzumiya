...
var navbarToggler = function navbarToggler() {
  ...
  var className = config.className,
      transformedClassName = config.transformedClassName;
  var navbarsCollection = Array.from(document.querySelectorAll('nav[data-toggleable=true]'));
  navbarsCollection.forEach(function (navbar) {
    var toggler = navbar.querySelector(".".concat(className.toggler));
    var hideable = navbar.querySelector(".".concat(className.navbar));
...
},{"./url":"../node_modules/socket.io-client/build/url.js","./manager":"../node_modules/socket.io-client/build/manager.js","./socket":"../node_modules/socket.io-client/build/socket.js","debug":"../node_modules/debug/src/browser.js","socket.io-parser":"../node_modules/socket.io-parser/dist/index.js"}],"scripts/main.js":[function(require,module,exports) {
"use strict";
